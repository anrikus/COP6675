...
to go
  ask patches
    [ set live-neighbors count patches in-radius 2 with [living?] ]
  ...
  ask patches
    [
     (ifelse live-neighbors = 1 or live-neighbors = 3 or live-neighbors = 5 or live-neighbors = 7
     [ cell-birth ]
     live-neighbors = 1 or live-neighbors = 3 or live-neighbors = 5 or live-neighbors = 7
     [ ]
     [ cell-death ])]
  tick
end
